                ...
                <div class="max-w-4xl mx-auto p-8 bg-white rounded shadow-lg mt-8">
                    ...
                    <div id="modal"
                        ...
                        <div class="bg-white p-8 rounded shadow-lg w-1/2">
                            ...
                            <form action="procesar_agregar_clase.php" method="POST">

                                <div class="mb-2">
                                    <label for="nombre_materia" class="block font-medium">Nombre de la Materia</label>
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white">
                                ...
                                <td class="py-2 px-4 border-r flex flex-row">
                                    <button class="text-blue-500 hover:underline" id="modalUpdateToggle"
                    ...
                    <div id="updateModal"
                        ...
                        <div class="bg-white p-8 rounded shadow-lg w-1/2">
                            ...
                            <!-- Formulario para actualizar clase -->
                            <form action="procesar_actualizar_clase.php" method="POST">
                                <input type="hidden" id="updateId" name="updateId">
                                <div class="mb-2">
                                    <label for="updateNombreClase" class="block font-medium">Nombre de la Clase:</label>
                                    <input type="text" id="updateNombreClase" name="updateNombreClase"
                                        class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                ...
                                <div class="mb-2">
                                    <label for="updateMaestroAsignado" class="block font-medium">Maestro
                                        Asignado:</label>
                                    <select id="updateMaestroAsignado" name="updateMaestroAsignado"
                                        class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
