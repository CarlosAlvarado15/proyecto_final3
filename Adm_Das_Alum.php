            ...
            <section class=" h-screen bg-blue-50">
                ...
                <div class="max-w-4xl mx-auto p-8 bg-white rounded shadow-lg mt-8">
                    ...
                    <div class="max-w-4xl mx-auto p-8 bg-white rounded shadow-lg mt-8">
                        <div class="flex justify-between mb-4">
                            ...
                            <button class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 cursor-pointer"
                                id="openModal">Agregar Alumno</button>
                        </div>
                                ...
                                <div class="bg-white p-8 rounded shadow-lg w-1/2">
                                    ...
                                    <form action="procesar_agregar_alumno.php" method="POST">
                                        <div class="mb-4">
                                            ...
                                            <input type="text" id="dni" name="dni" placeholder="Ingresa la Matricula"
                                        ...
                                        <div class="mb-4">
                                            ...
                                            <input type="email" id="correo" name="correo" placeholder="Ingresa el email"
                                                class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                        </div>
                                        <div class="mb-4">
                        ...
                        <table class="w-full border-collapse border mt-4">
                            ...
                            <tbody>
                                ...
                                $query = "SELECT * FROM usuarios_datos WHERE rol_id = 3";
                                ...
                                while ($row = $result->fetch_assoc()) {
                                    ...
                                    echo "<td class='py-2 px-4 border-r'>" . $row[''] . "</td>";
                            ...
                            <div class="bg-white p-8 rounded shadow-lg w-1/2">
                                ...
                                <form action="procesar_actualizar_alumno.php" method="POST">
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <input type="int" id="updateDni" name="updateDni"
                                    ...
                                    <div class="mb-2">
                                        <label for="updateFechaNacimiento" class="block font-medium">Fecha de
                                            Nacimiento:</label>
                                        <input type="date" id="updateFechaNacimiento" name="updateFechaNacimiento"
                                            class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                    </div>
                                    <div class="flex justify-end gap-2 mt-6">
                                        <button type="button"
                    ...
                    function openUpdateModal(button) {
                        ...
                        document.getElementById('updateDireccion').value = fechaNacimiento;
