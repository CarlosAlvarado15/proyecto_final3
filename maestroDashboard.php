            ...
            <div class="px-6">
                ...
                <div class="mt-6 space-y-2">
                    ...
                    <button class=" flex flex-row justify-center  group">
                        ...
                        <div class="hidden group-focus:block top-full min-w-full w-max bg-black  mt-1 rounded">
                            <ul class="text-left border none">
                                <li class=" px-4 py-1 border-b"> Lista de Alumnos </li>
                                <li class=" px-4 py-1"> Agregar Alumno</li>
                            </ul>
