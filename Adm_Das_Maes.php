...
// Crear una conexión a la base de datos MySQL (reemplaza los valores con tus propias credenciales)
...
// Obtener los datos de los maestros desde la base de datos
$sql = "SELECT `id_ud`,`nombre`,`correo`,`direccion`,`fecha_nacimiento`,`nombre_materia`,`id_materia` FROM materia LEFT JOIN `maestro_materia` on materia.id_materia = maestro_materia.materia_id RIGHT JOIN `usuarios_datos` on maestro_materia.maestro_id = usuarios_datos.id_ud LEFT JOIN `usuarios_login` on id_ud = usuarios_login.datos_id WHERE rol_id=2";
        ...
        <div class="flex flex-col w-[calc(100%-15rem)] px-2">
            ...
            <section class=" h-screen bg-blue-50">
                ...
                <div class="max-w-4xl mx-auto p-8 bg-white rounded shadow-lg mt-8">
                    ...
                    <div id="updateModal"
                        ...
                        <div class="bg-white p-8 rounded shadow-lg w-1/2">
                            ...
                            <form action="procesar_actualizar_maestro.php" method="POST">
                                ...
                                <div class="mb-2">
                                    <label for="updateApellidos" class="block font-medium">Direccion:</label>
                                    <input type="text" id="updateApellidos" name="updateApellidos"
                                        class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                                <div class="mb-2">
                                    <label for="updatefecha_naciemiento" class="block font-medium">Fecha de
                                        Nacimiento:</label>
                                    <input type="text" id="updatefecha_naciemiento" name="updateApellidos"
                                        class="w-full border px-3 py-2 rounded focus:outline-none focus:ring focus:border-blue-300">
                                </div>
                    ...
                    <table class="w-full border-collapse border" id="tablaMaestros">
                        ...
                        <tbody>
                            <?php
                            // Iterar sobre los datos de los maestros y generar las filas de la tabla
                ...
                function openUpdateModal(button) {
                    ...
                    const direccion = row.cells[3].textContent;
                    const fechaNacimiento = row.cells[4].textContent;
                    const claseAsignada = row.cells[5].textContent;
                    ...
                    document.getElementById('updateApellidos').value = direccion;
                    // Agrega los campos adicionales que necesites actualizar
