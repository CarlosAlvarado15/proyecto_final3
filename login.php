...
if (isset($_POST['email']) && isset($_POST['password'])) {
    ...
    // Realizar la validación de las credenciales aquí
    // ...

    if ($email === 'admin@admin' && $password === '3333') {
        // Configurar una variable de sesión para rastrear el rol del usuario
        session_start();
        $_SESSION['role'] = 'admin';
        ...
        // Si la validación no es exitosa, mostrar un mensaje de error o tomar medidas apropiadas.
    }
}
?>
