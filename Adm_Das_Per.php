...
<body>
                    ...
                    <div class="bg-white p-8 rounded-lg shadow-md w-96">
                        ...
                        <form class="text" id="permisosForm">
                            ...
                            <button type="button" id="cerrar"
                                class="bg-gray-400 text-white px-4 py-2 rounded mr-2">Cerrar</button>
                            <button type="submit" id="guardarCambios"
                                class="bg-blue-500 text-white px-4 py-2 rounded">Guardar
                                Cambios</button>
                        </form>
                    </div>
                </div>
    ...
    // Datos de ejemplo (simulación de datos de la base de datos)
    const usuarios = [{
    ...
    function cargarUsuarios() {
        ...
        // Agregar evento de clic para abrir el modal de edición
        const botonesEditar = document.querySelectorAll('.editar');
        botonesEditar.forEach(boton => {
            boton.addEventListener('click', () => {
                const usuario = JSON.parse(boton.getAttribute('data-usuario'));
                // Preenlazar campos del modal con los datos del usuario
    ...
    // Traducir el valor del permiso a una etiqueta legible
